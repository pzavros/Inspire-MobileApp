            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  alignment: Alignment.center,
                  child: Countdown(
                    seconds:widget.listOfQuestions[i]['timer'],
                    build: (BuildContext context, double time) => Text(time.toString()),
                    interval: Duration(milliseconds: 100),
                    onFinished: () {
                      print('Timer is done!');
                ...
                Container(
                  ...
                  child:
                  (widget.listOfQuestions[i]['image'])?SizedBox(height: 400,width: 340, child: Image.network(widget.listOfQuestions[i]['question']),):
                  Text('Question:  '+
                  ...
                  onPressed: () async {
                    setState(() {
                      if (i < widget.listOfQuestions.length - 1) {
                        i++;
                        // move to next question for players
                        dbRef.update({
                          'position':i,
                        });
                      }
